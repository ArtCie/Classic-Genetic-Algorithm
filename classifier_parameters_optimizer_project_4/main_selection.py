...
def mutationSVC(individual):
    numberParamer = random.randint(0, 4)
    if numberParamer == 0:
        # kernel
        listKernel = ["linear", "rbf", "poly", "sigmoid"]
    ...
    numberParamer_2 = random.randint(5, len(individual) - 1)
    if individual[numberParamer_2] == 0:
        individual[numberParamer_2] = 1
    else:
        individual[numberParamer_2] = 0
...
#------- main data - 3
# df = pd.read_csv("data/biodeg.csv", header=None, delimiter=';')
